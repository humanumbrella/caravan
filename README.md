...
different port, for example: `http://localhost:1337/localhost:18332`.

Finally, a testnet node running on a different machine but still on the same
network might be accessible via `http://localhost:1337/192.168.0.22:18332`, but
you need to make sure the ports are open and accessible.
